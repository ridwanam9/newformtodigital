                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Laporan Form Tranfer Intra Rumah Sakit</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                    @foreach ($dataFormInput as $items)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="{{ route('export-pdf', $items->id) }}" class="btn btn-warning">Export PDF</a>
